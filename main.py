...
#LAB 9 QUESTION 1
 try:
    ...
    print(e.args)
    print("Invalid input. player needs to enter integer number for combat strength ")
    i += 1
    continue

    # Note: ombat_strength was safe to cast combat_strength to integer
...
#lab 9 Question 2 
try:
  health_points = function.monster_attacks(m_combat_strength="somestring1", health_points="somestring1")
except TypeError:
